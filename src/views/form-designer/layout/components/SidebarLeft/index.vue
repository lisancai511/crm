...
import {
  ...
  fieldComponents,
  field
} from '@/views/form-designer/config/components'
...
export default class SidebarLeft extends Vue {
  basicComponents: field[] = basicComponents
  fieldComponents: field[] = fieldComponents
  unusedFields: field[] = [
    {
      name: '测试字段',
      icon: 'edit',
      type: LayoutTypes.TextField,
      key: LayoutTypes.TextField + 'asdkljaslkf',
      attrs: {
        maxlength: 20
      }
    }
